			...
			<div align="center">
				...
				<div id="migas">
						<ul id="breadcrumbs-one">
    						...
    						<li><a href="Menu_Solicitudes.php">Menú Solicitud</a></li>
    						<li><a href="Enviar_Formato_Solicitud_Administrativo.php">Formato Administrativo</a></li>
						</ul>
				</div>
			</div>
		</div>
					...
					<div>
						...
						<img src="./Control_Mantenimiento_Infraestructura_files/Img/Volver.png" style="position: absolute; left: 35px; top: 610px;" width="250" height="80" alt="Volver" title="Click para regresar a la página anterior"></img>
                            ...
                            <form  method="post" action="Validar_Solicitud_Administrativo.php" style="position: absolute; left: 410px; top: 320px;"> 
                                <h1> Formato De Solicitud ADMINISTRATIVO</h1>
                                <div class="inset"> 
	                                <p> 
