			...
			<div align="center">
				...
				<div id="migas">
						<ul id="breadcrumbs-one">
    						...
    						<li><a href="Pagina_Principal_Estudiantes.php">Página Principal Estudiantes</a></li>
    						<li><a href="Enviar_Formato_Solicitud_Estudiantes.php">Formato Solicitud</a></li>
						</ul>
				</div>
			</div>
		</div>
			...
			<div id="path"></div>
				<div id="inicio">
					...
					<div>
						...
						<a href="Pagina_Principal_Estudiantes.php">
						<img src="./Control_Mantenimiento_Infraestructura_files/Img/Volver.png" style="position: absolute; left: 35px; top: 610px;" width="250" height="80" alt="Volver" title="Click para regresar a la página anterior"></img>
                            ...
                            <form  method="post" action="Validar_Solicitud_Estudiantes.php" style="position: absolute; left: 410px; top: 320px;"> 
                                <h1> Formato De Solicitud ESTUDIANTES</h1>
                                <div class="inset"> 
	                                <p> 
