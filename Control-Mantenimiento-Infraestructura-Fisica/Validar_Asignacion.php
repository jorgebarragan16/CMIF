...
mysql_query("INSERT INTO asignacion VALUES ('','$observaciones',{$result->Usuario_Id_Usuario}, '$solicitud','$contratista',1)",$link) or die('"<script> alert("'.mysql_error().'")</script>" "<script> window.location="Realizar_Asignacion.php"</script>');
